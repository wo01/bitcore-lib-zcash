...
Transaction.prototype.toBufferWriter = function(writer) {
  ...
  if (this.version >= 2) {
    ...
    _.each(this.joinSplits, function(jsdesc) {
      jsdesc.toBufferWriter(writer, this.version);
    });
...
Transaction.prototype.toObject = Transaction.prototype.toJSON = function toObject() {
  ...
  if (this.version >= 2) {
    ...
    this.joinSplits.forEach(function(joinSplit) {
      joinSplits.push(joinSplit.toObject(this.version));
    });
...
Transaction.prototype.fromObject = function fromObject(arg) {
  ...
  if (this.version >= 4) {
    this.nValueBalance = obj.nValueBalance;
  ...
  if (this.version >= 2) {
    _.each(transaction.joinSplits, function(joinSplit) {
      self.joinSplits.push(new JSDescription(joinSplit, this.version));
    });

...
Transaction.prototype.toBufferWriter = function(writer) {
  ...
  if (this.fSaplinged) {
    writer.writeUInt64LEBN(this.nValueBalance);
    writer.writeVarintNum(this.vShieldedSpend.length);
//    _.each(this.vShieldSpend, function(vshlledspend) {
//      vshieldspend.toBufferWriter(writer);
//    });
    writer.writeVarintNum(this.vShiededOutput.length);
//    _.each(this.vShieldOutput, function(vshieldoutput) {
//      vshieldoutput.toBufferWriter(writer);
//    });
  }
  ...
  if (fSaplinged && !(this.vShieldedSpend.empty() && this.vShieldedOutput.empty())) {
...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  if (this.version >= 4) {
    this.nValueBalance = reader.readUInt64LEBN();
...
Transaction.prototype.toObject = Transaction.prototype.toJSON = function toObject() {
  ...
  if (this.version >= 4) {
    obj.nValueBalance = this.nValueBalance;
    var shieldedSpends= [];
  ...
  if (this.version >= 4 && !(this.vShieldedSpend && this.vShieldedOutput))
